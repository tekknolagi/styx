...
private:
    ...
    /*
        rendered on 2017-Aug-19 04:34:25.5602452 by IsItThere.
         - PRNG seed: 6574
         - map length: 128
         - case sensitive: true
    */

    static const string[128] _words = ["", "protection", "", "f64", "", "s8", "class", "", "finally", "", "try", "union", "false", "if", "", "", "", "", "", "", "break", "u64", "", "", "", "", "", "", "", "", "static", "", "return", "", "", "", "", "", "in", "s64", "", "", "", "", "f32", "", "virtual", "", "aka", "is", "", "version", "", "", "", "", "continue", "", "", "", "", "", "u32", "", "", "", "", "var", "", "", "", "u16", "", "", "const", "true", "", "", "", "switch", "s32", "enum", "unit", "", "", "function", "import", "", "", "s16", "foreach", "", "on", "", "", "struct", "interface", "", "", "", "while", "", "", "", "ureg", "", "", "null", "", "", "", "auto", "", "super", "", "u8", "", "", "", "", "else", "", "sreg", "", "", "bool", "", "throw"];
