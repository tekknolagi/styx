...
private:
    ...
    /*
        rendered on 2018-Feb-28 06:28:20.581305 by IsItThere.
         - PRNG seed: 6574
         - map length: 128
         - case sensitive: true
    */

    static const string[128] _words = ["", "", "", "s16", "", "", "continue", "", "", "var", "", "", "on", "", "static", "", "", "else", "s8", "", "", "", "switch", "u16", "", "throw", "goto", "interface", "", "import", "", "", "class", "", "", "", "", "f64", "u8", "", "protection", "", "", "", "", "", "", "", "", "", "break", "", "", "", "struct", "unit", "", "", "if", "", "", "", "aka", "", "while", "", "s64", "return", "", "try", "init", "", "const", "", "f32", "true", "label", "foreach", "", "enum", "ssize", "", "", "union", "", "", "u64", "is", "version", "in", "", "", "", "", "finally", "", "template", "bool", "false", "", "usize", "super", "", "s32", "", "", "", "", "", "", "", "", "", "", "function", "auto", "null", "", "assert", "", "", "virtual", "", "u32", "", "", "", ""];
